...
@EventBusSubscriber(modid = OreAdditions.MODID)
...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(true, new ModDatapackProvider(packOutput, lookupProvider));   //Needed to add the ore generation of the silver and tin ore to the game
